...
gulp.task('images', function () {
    return gulp.src('src/assets/img/*').pipe(image()).pipe(gulp.dest('dist/assets/img'));
});

gulp.task('css', () => {
    return gulp
        .src('./src/assets/scss/lazy_loading.scss')
        ...
        .on('end', () => {
            ...
            //         const now = new Date();
            //         console.log(
            //             `[${now.getHours()}:${now.getMinutes()}:${now.getSeconds()}] Compress css finished`,
            //         );
            //     });
        });
});
...
gulp.task('default', gulp.series('js', 'images', 'css'));
